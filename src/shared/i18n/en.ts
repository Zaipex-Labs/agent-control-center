...
export const en: Record<string, string> = {
  ...
  'dash.avatarSeedLabel': 'Custom seed',
  'dash.avatarSeedPlaceholder': 'e.g. wizard-cat, turing-2026',
  ...
  // FU-AE v0.4.0 — cost preview keys. Disclaimers MUST stay
  // visible inline, not behind a hover (FASE E directive).
  'dash.cost.turns': 'turns',
  'dash.cost.howItWorks': 'How is this calculated?',
  'dash.cost.disclaimer.low': 'Initial estimate — accuracy improves as the project accumulates usage.',
  'dash.cost.disclaimer.medium': 'Estimate based on partial data — range is intentionally wide.',
  'dash.cost.disclaimer.high': 'Based on this project\'s recent average.',
  'dash.cost.explain.intro': 'Cost previews combine your team size, message complexity, and historical token usage.',
  'dash.cost.explain.agents': 'Active specialists in this project: {count}',
  'dash.cost.explain.complexity': 'Detected complexity: {level}',
  'dash.cost.explain.source': 'Source: {source} (sample size {sampleSize}).',
  'dash.cost.explain.avgPerTurn': 'Project avg cost per turn: ${avg}',
  'dash.cost.explain.disclaimer': 'The number is a guide, not a quote. Anthropic\'s billed cost is what you\'ll see; this estimate may be off by a factor of 2-3× until enough usage rows accumulate (~100).',
  'dash.cost.source.realData': 'this project\'s last 30 days',
  'dash.cost.source.synthetic': 'synthetic baseline (v0.3.3 calibration)',
