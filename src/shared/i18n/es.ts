...
export const es: Record<string, string> = {
  ...
  'dash.agentIdHeader': 'Agente ID',
  'dash.agentConfigHeader': 'Configuraci\u00f3n del agente',
  'dash.agentNameLabel': 'Nombre',
  'dash.agentRoleLabel': 'Rol',
  'dash.modelLabel': 'Modelo',
  'dash.pathLabel': 'Ruta del proyecto',
  'dash.instructionsPlaceholder': 'Prompt de sistema opcional para este agente...',
  'dash.offline': 'desconectado',
  'dash.idStatus': 'Estado',
  'dash.idProject': 'Proyecto',
  ...
  'dash.metTwo': '{a} y {b} se reunieron',
  'dash.metOne': '{a} trabaj\u00f3 solo',
  'dash.emptyOfficeTitle': 'Los agentes est\u00e1n en sus escritorios',
  'dash.emptyOfficeSub': 'Selecciona un hilo o empieza una conversaci\u00f3n',
  'dash.workDesk': 'Escritorio de trabajo',
  'dash.noFilesYet': 'A\u00fan no hay archivos modificados',
  'dash.copiedPath': 'Ruta copiada',
  'dash.copyFailed': 'No se pudo copiar la ruta',
  'dash.noMentionFound': 'Ning\u00fan mensaje del chat menciona \u201c{path}\u201d todav\u00eda',
  'dash.savedToastShort': 'Sesi\u00f3n guardada',
  'dash.saveFailed': 'No se pudo guardar la sesi\u00f3n',
  'dash.unsavedTitle': 'Cambios sin guardar',
  'dash.unsavedBody': 'Tienes actividad que no se ha guardado. Al guardar se genera un resumen para que los agentes retomen donde los dejaste la pr\u00f3xima vez. \u00bfQu\u00e9 quieres hacer?',
  'dash.saveAndShutdown': 'Guardar y apagar',
  'dash.shutdownWithout': 'Apagar sin guardar',
  'dash.dirty': 'Sin guardar',
  'dash.saved': 'Guardado {ago}',
  'dash.createThreadCta': 'Iniciar nueva conversaci\u00f3n',
  'dash.deleteTeam': 'Eliminar equipo',
  'dash.deleteTeamTitle': '\u00bfEliminar equipo "{name}"?',
  'dash.deleteTeamBody': 'Esto elimina la configuraci\u00f3n del proyecto de tu m\u00e1quina. El historial de git de los agentes queda intacto. No se puede deshacer.',
  'dash.deleteTeamConfirm': 'Eliminar equipo',
  'dash.deleteThread': 'Eliminar conversaci\u00f3n',
  'dash.deleteThreadTitle': '\u00bfEliminar "{name}"?',
  'dash.deleteThreadBody': 'La conversaci\u00f3n desaparece del sidebar. Los mensajes quedan en el historial del equipo pero ya no est\u00e1n agrupados bajo este hilo.',
  'dash.deleteThreadConfirm': 'Eliminar',
  'dash.errorDeleting': 'Error al eliminar: {error}',
  ...
  'dash.restartTeam': 'Reiniciar equipo',
  'dash.agentsOfflineTitle': 'El equipo est\u00e1 fuera de l\u00ednea',
  'dash.agentsOfflineBody': 'Parece que los agentes se desconectaron — reinicia el equipo para seguir platicando.',
  'dash.reconnectingTitle': 'Reconectando al equipo…',
  'dash.reconnectingBody': 'Estamos volviendo a prender tus agentes. Normalmente tarda unos segundos.',
  'dash.shuttingDownTeam': 'Apagando al equipo',
  ...
  'dash.send': 'Enviar',
  'dash.attach.button': 'Adjuntar archivo',
  'dash.attach.dropHere': 'Suelta para adjuntar',
  'dash.attach.uploading': 'Subiendo adjuntos…',
  ...
  // FU-AE v0.4.0 — cost preview keys. Los disclaimers DEBEN
  // quedar visibles inline, no escondidos en hover (FASE E).
  'dash.cost.turns': 'turnos',
  'dash.cost.howItWorks': '¿Cómo se calcula?',
  'dash.cost.disclaimer.low': 'Estimación inicial — la precisión mejora con uso real del proyecto.',
  'dash.cost.disclaimer.medium': 'Estimación con datos parciales — el rango es ancho a propósito.',
  'dash.cost.disclaimer.high': 'Basado en el promedio reciente de este proyecto.',
  'dash.cost.explain.intro': 'La estimación combina el tamaño del equipo, la complejidad del mensaje y el historial de uso de tokens.',
  'dash.cost.explain.agents': 'Especialistas activos en este proyecto: {count}',
  'dash.cost.explain.complexity': 'Complejidad detectada: {level}',
  'dash.cost.explain.source': 'Fuente: {source} (tamaño de muestra {sampleSize}).',
  'dash.cost.explain.avgPerTurn': 'Costo promedio por turno (proyecto): ${avg}',
  'dash.cost.explain.disclaimer': 'El número es una guía, no una cotización. Lo que cobre Anthropic es lo que aparece en tu factura; esta estimación puede estar errada por un factor de 2-3× hasta que se acumulen suficientes filas de uso (~100).',
  'dash.cost.source.realData': 'últimos 30 días de este proyecto',
  'dash.cost.source.synthetic': 'baseline sintético (calibración v0.3.3)',
